...
Complements `docs/gold-db/market_terminal_gold_views.md` (which plans Gold-layer views
...
3. Cross-checked against `docs/gold-db/market_terminal_gold_views.md` §7, which already
...
**Design note:** `docs/gold-db/market_terminal_gold_views.md` §7 says international
